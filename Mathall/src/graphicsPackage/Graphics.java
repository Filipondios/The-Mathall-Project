...
public class Graphics {
	...
	public void GraphicsMenu() {
		...
		System.out.println(white+" ├─["+yellow+"0"+white+"]─ Exit Mathall                          "+purple+"██ ██   █ █   █   █   █   █ █   █    █");
		System.out.println(white+" ├─["+yellow+"1"+white+"]─ Matrix Operations                     "+purple+"█ █ █  █   █  █   █████  █   █  █    █");
		System.out.println(white+" └─["+yellow+"2"+white+"]─ Equation Systems Resolution           "+purple+"█   █  █████  █   █   █  █████  █    █");
